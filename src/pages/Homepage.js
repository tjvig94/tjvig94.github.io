        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-md-12">
                    <img src="images/Headshot.png" class="mx-auto d-block headshot" alt="Tim Vigneau"></img>
                </div>
                <div class="col-xl-6 text-center title">
                    ...
                    <div class="row mb-5">
                        <div class="col-4">
                            <a href="https://github.com/tjvig94" target="_blank" rel="noreferrer">
                                <img src="images/github.png" alt="github page" class="social-icon"></img>
                            </a>
                        </div>
                        <div class="col-4">
                            <a href="https://www.linkedin.com/in/tim-vigneau/" target="_blank" rel="noreferrer">
